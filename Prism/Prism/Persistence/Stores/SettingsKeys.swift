...
enum SettingsKeys {
    ...
    static let sttLocaleIdentifier = "audio.stt.locale"
    ...
    static let skillWeatherEnabled = "skills.weather.enabled"
    static let skillMusicEnabled = "skills.music.enabled"
    static let skillRemindersEnabled = "skills.reminders.enabled"
    static let weatherUnits = "skills.weather.units"
    static let skillsEnabledPrefix = "skills."
    static let wakeWordEnabled = "wakeWord.enabled"
    static let wakeWordSensitivity = "wakeWord.sensitivity"
    static let wakeWordMinConfidence = "wakeWord.minConfidence"
    static let wakeWordAliases = "wakeWord.aliases"
}
